---
id: 12d9ca4f-6459-4125-aa81-b2d517ee57a4
...
- `/assets/content/posts/my-post/diagram.png`
- `/assets/shared/fonts/main.woff2`
...
- **Minify CSS** via `site.yaml` build options
...
- **Structured data**: Add JSON-LD to `head.html`
- **Sitemap**: Enabled by default in RSS feeds
- **Open Graph**: Add tags in `partials/head.html`
- **Heading hierarchy**: Use `h2`, `h3`, not multiple `h1`s
